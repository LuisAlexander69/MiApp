...
- OpenWebinars. (s/f). *Gestión de la calidad en el desarrollo de software*. https://openwebinars.net/blog/gestion-de-la-calidad-en-el-desarrollo-de-software/  
- ScienceDirect. (s/f). *Requirement Analysis Phase*. https://www.sciencedirect.com/topics/computer-science/requirement-analysis-phase  
- The Decision Lab. (s/f). *Nielsen’s Heuristics*. https://thedecisionlab.com/reference-guide/design/nielsens-heuristics  
- Onabitz. (2025). *La tecnología es solo una herramienta: el objetivo resolver problemas reales*. https://onabitz.com/blog/la-tecnologia-es-solo-una-herramienta-el-objetivo-resolver-problemas-reales
